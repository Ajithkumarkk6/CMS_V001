...
from company.models import VehicleTypes, VehicleDetails, CompanyBranchWeeklyCalendar, CompanyDocument, CompanySector, CompanyTypeOfBusiness, CompanyMeta, CompanyBranchInfo, CompanyContactInfo, CompanyGeoLocationInfo, CompanyDepartment, WeekDay
