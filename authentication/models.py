...
class AppBaseConfig(BaseModelMixin):
    current_version_android = models.CharField(max_length=8, null=True, blank=True)
    minimum_support_version_android = models.CharField(max_length=8, null=True, blank=True)
    current_version_ios = models.CharField(max_length=8, null=True, blank=True)
    minimum_support_version_ios = models.CharField(max_length=8, null=True, blank=True)
    last_sync_time = models.DateTimeField(auto_now=False, null=True, blank=True)
...
class UserAuthentication(BaseModelMixin):
    ...
    admin_registration_designation = models.CharField(max_length=200, null=True, blank=True)
