...
from employee.models import EmployeeDesignation, EmployeeDocument, EmployeeDocumentGroup, EmployeeDocumentLocker, EmployeeFacePhoto, EmployeePersonalInfo, EmployeeFinancialInfo, EmployeeCompanyInfo
        ...
        if validation.is_valid() and request_info['company_info'] is not None and (request_info['is_admin'] or request_info['is_branch_admin']):
            if 'id' in data:
                ...
                try:
                    ...
                    pass
                employeeCompanyInfo.designation_name = data['designation_name'] 
                employeeCompanyInfo.departmant_name = data['department_name'] 
