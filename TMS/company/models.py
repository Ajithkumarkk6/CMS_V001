...
class CompanyGeoLocationInfo(BaseModelMixin):
    ...
    fencing_radius = models.IntegerField(
        default=DEFAULT_RADIUS, null=True, blank=True)


class CompanyBranchInfo(BaseModelMixin):
    company = models.ForeignKey(
        CompanyMeta, on_delete=models.CASCADE, null=True, blank=True)
    provider_company_branch = models.ForeignKey(
        'self', related_name='admin_company_branch', on_delete=models.CASCADE, null=True, blank=True)
    ...
    company_contact = models.ForeignKey(
        CompanyContactInfo, unique=True, on_delete=models.SET_NULL, null=True, blank=True)
    company_geolocation = models.ForeignKey(
        CompanyGeoLocationInfo, unique=True, on_delete=models.SET_NULL, null=True, blank=True)

    def __str__(self):
        title = str(self.display_name) + "===" + \
...
class CompanyBranchWeeklyCalendar(BaseModelMixin):
    ...
    day_mon = models.ForeignKey(
        WeekDay, related_name='monday', on_delete=models.SET_NULL, null=True, blank=True)
    day_tue = models.ForeignKey(
        WeekDay, related_name='tuesday', on_delete=models.SET_NULL, null=True, blank=True)
    day_wed = models.ForeignKey(
        WeekDay, related_name='wednesday', on_delete=models.SET_NULL, null=True, blank=True)
    day_thu = models.ForeignKey(
        WeekDay, related_name='thursday', on_delete=models.SET_NULL, null=True, blank=True)
    day_fri = models.ForeignKey(
        WeekDay, related_name='friday', on_delete=models.SET_NULL, null=True, blank=True)
    day_sat = models.ForeignKey(
        WeekDay, related_name='saturday', on_delete=models.SET_NULL, null=True, blank=True)
    day_sun = models.ForeignKey(
        WeekDay, related_name='sunday', on_delete=models.SET_NULL, null=True, blank=True)
...
class CompanyDocument(BaseModelMixin):
    ...
    photo = models.ImageField(
        upload_to='company_document', null=True, blank=True)
