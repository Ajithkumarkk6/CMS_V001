...
KEY_D_APPOINTMENT_PLACED_SUCCESSFULLY = "APPOINTMENT_PLACED_SUCCESSFULLY"
...
KEY_D_APPOINTMENT_MARKED_AS_REJECTED = "APPOINTMENT_MARKED_AS_REJECTED"
KEY_D_APPOINTMENT_MARKED_AS_ACCEPTED = "APPOINTMENT_MARKED_AS_ACCEPTED"
KEY_D_APPOINTMENT_MARKED_AS_CHECKEDIN = "APPOINTMENT_MARKED_AS_CHECKEDIN"
KEY_D_APPOINTMENT_MARKED_AS_COMPLETED = "APPOINTMENT_MARKED_AS_COMPLETED"
...
KEY_D_APPOINTMENT_APPROVED = "APPOINTMENT_APPROVED"
KEY_D_APPOINTMENT_REJECTED = "APPOINTMENT_REJECTED"
...
KEY_D_APPOINTMENT_STATUS_CANCELLED = "KEY_D_APPOINTMENT_STATUS_CANCELLED"
KEY_D_BOOKING_NO_SHOW = "KEY_D_BOOKING_NO_SHOW"
...
valueset = {
    ...
    KEY_D_APPOINTMENT_PLACED_SUCCESSFULLY: {KEY_LANGUAGE_EN: "Order Placed Successfully", KEY_LANGUAGE_TA: "ஆர்டர் வெற்றிகரமாக சேர்க்கப்பட்டுள்ளது "},
    ...
    KEY_D_APPOINTMENT_MARKED_AS_REJECTED: {KEY_LANGUAGE_EN: "Order Marked as Rejected", KEY_LANGUAGE_TA: "ஆர்டர் நிராகரிக்கப்பட்டது எனக் குறிக்கப்பட்டுள்ளது"},
    KEY_D_APPOINTMENT_MARKED_AS_ACCEPTED: {KEY_LANGUAGE_EN: "Order Marked as Accepted", KEY_LANGUAGE_TA: "ஆர்டர் ஏற்றுக்கொள்ளப்பட்டதாகக் குறிக்கப்பட்டுள்ளது"},
    KEY_D_APPOINTMENT_MARKED_AS_CHECKEDIN: {KEY_LANGUAGE_EN: "Order Marked as Checked In", KEY_LANGUAGE_TA: "ஆர்டர் செக்-இன் எனக் குறிக்கப்பட்டது"},
    KEY_D_APPOINTMENT_MARKED_AS_COMPLETED: {KEY_LANGUAGE_EN: "Order Marked as Completed", KEY_LANGUAGE_TA: "ஆர்டர் முடிந்தது எனக் குறிக்கப்பட்டுள்ளது"},
    ...
    KEY_D_APPOINTMENT_APPROVED: {KEY_LANGUAGE_EN:"Order Approved", KEY_LANGUAGE_TA: "ஆர்டர் அங்கீகரிக்கப்பட்டது"},
    KEY_D_APPOINTMENT_REJECTED: {KEY_LANGUAGE_EN: "Order Rejected", KEY_LANGUAGE_TA: "ஆர்டர் நிராகரிக்கப்பட்டது"},
    KEY_D_NOT_REACHABLE: {KEY_LANGUAGE_EN: "Not Reachable", KEY_LANGUAGE_TA:"தொடர்பு கொள்ள முடியவில்லை"},
    KEY_D_BOOKING_NO_SHOW: {KEY_LANGUAGE_EN: "No Show", KEY_LANGUAGE_TA: "தொடர்பு கொள்ள முடியவில்லை"},
    ...
    KEY_D_APPOINTMENT_STATUS_CANCELLED: {KEY_LANGUAGE_EN:  "Order Cancelled", KEY_LANGUAGE_TA: "ஆர்டர் நிராகரிக்கப்பட்டது"},
...
APPOINTMENT_STATUS_INITIATED = "ORD_INITIATED"
APPOINTMENT_STATUS_AGENT_APPROVED = "ORD_APPROVED"
APPOINTMENT_STATUS_AGENT_REJECTED_NO_SLOT = "ORD_REJECTED_NO_SLOT"
APPOINTMENT_STATUS_AGENT_REJECTED_OTHERS = "ORD_REJECTED_OTHERS"
APPOINTMENT_STATUS_CANCELLED = "ORD_CANCELLED"
APPOINTMENT_STATUS_NO_SHOW = "ORD_NO_SHOW"
APPOINTMENT_STATUS_ONGOING = "ORD_ONGOING"
APPOINTMENT_STATUS_COMPLETED = "ORD_COMPLETED"
...
def get_string_value_by_user(key):
