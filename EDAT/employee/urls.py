...
urlpatterns = [
    ...
    path('addStudent', views.AddStudent.as_view(), name='addEmployee'),
    ...
    path('raiseAnonymousComplaint', views.RaiseAnonymousComplaint.as_view(), name='raiseAnonymousComplaint'),
