...
urlpatterns = [
    ...
    path('addBranchLocation', views.AddBranchLocation.as_view(),
         name='addBranchLocation'),
    path('updateBranchLocation', views.UpdateBranchLocation.as_view(),
         name='updateBranchLocation'),
    ...
    path('getTypeOfBusiness', views.GetTypeOfBusiness.as_view(),
         name='getTypeOfBusiness'),
    path('getStoreDetails', views.GetStoreDetails.as_view(), name='getStoreDetails'),
    path('getCustomerHomeContent', views.GetCustomerHomeContent.as_view(),
         name='getCustomerHomeContent'),


    path('getAssociatedCompanies', views.GetAssociatedCompanies.as_view(),
         name='getAssociatedCompanies'),
